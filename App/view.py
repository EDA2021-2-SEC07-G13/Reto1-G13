...
def printSortResultsArtworks(ord_artworks, fecha_1, fecha_2):
    ...
    for x in list_id_artwork_1:
        for y in range(1,lt.size(artists)+1):
            
            if str((lt.getElement(artists,y))['ConstituentID']).replace("[","").replace("]","") == x:
                artistas_artwork1 =  str((lt.getElement(artists,y))['DisplayName'])
                break
    ...
    for x in list_id_artwork_2:
        for y in range(1,lt.size(artists)+1):
            ...
            if str((lt.getElement(artists,y))['ConstituentID']).replace("[","").replace("]","") == x:
                artistas_artwork2 =  str((lt.getElement(artists,y))['DisplayName'])
                break
    ...
    for x in list_id_artwork_3:
        for y in range(1,lt.size(artists)+1):
            ...
            if str((lt.getElement(artists,y))['ConstituentID']).replace("[","").replace("]","") == x:
                artistas_artwork3 =  str((lt.getElement(artists,y))['DisplayName'])
                break
    ...
    for x in list_id_artwork_4:
        for y in range(1,lt.size(artists)+1):
            ...
            if str((lt.getElement(artists,y))['ConstituentID']).replace("[","").replace("]","") == x:
                artistas_artwork4 =  str((lt.getElement(artists,y))['DisplayName'])
                break
    ...
    for x in list_id_artwork_5:
        for y in range(1,lt.size(artists)+1):
            ...
            if str((lt.getElement(artists,y))['ConstituentID']).replace("[","").replace("]","") == x:
                artistas_artwork5 =  str((lt.getElement(artists,y))['DisplayName'])
                break
    ...
    for x in list_id_artwork_6:
        for y in range(1,lt.size(artists)+1):
            ...
            if str((lt.getElement(artists,y))['ConstituentID']).replace("[","").replace("]","") == x:
                artistas_artwork6 =  str((lt.getElement(artists,y))['DisplayName'])
                break
...
while True:
    ...
    if int(inputs[0]) == 1:
        ...
        for x in range(1,lt.size(artists)):
            lt.addLast(nombres_artistas, lt.getElement(artists,x)['DisplayName'])
            lt.addLast(id_artistas, lt.getElement(artists,x)['ConstituentID'])
